...
require('includes/config.php'); 	
	...
	{
		$isbn=$_GET['isbn'];
	$query="insert into shipping_details(name,address,postal_code,city,state,phone,f_id,isbn) values('$name','$address','$pc','$city','$state','$phone','$uid','$isbn')";
...
<body>
      ...
      <div  class="form">
    		<form id="contactform" method="post"> 
                ...
                <p class="contact"><label for="state">Email</label></p> 
    			<input type="text" id="state" name="state" required="" placeholder="oninebookshop@xyz.com"> 
